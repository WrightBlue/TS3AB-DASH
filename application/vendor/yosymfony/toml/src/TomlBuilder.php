...
class TomlBuilder
{
     ...
     * @param bool $newLine Ne line
     *
     * @return TomlBuilder The TomlBuilder itself
     */
    public function addComment(string $comment, bool $newLine = false) : TomlBuilder
    {
        $this->append($this->dumpComment($comment, $newLine), true);
    ...
    private function dumpComment(string $val, bool $new) : string
    {
    	if ($new) {
			return "\n#".$val;
		}
